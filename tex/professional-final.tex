...
\colorlet{color3}{magenta!40}%  for foot rule, footer and link
...
%	right=\dimexpr1.8in+\parindent\relax,
	enlarge right by=-1.8in,
	right=\dimexpr1.8in+0.5ex\relax,
	leftrule=0.5pt,
	rightrule=0pt,
	toprule=0pt,
	bottomrule=0pt,
	...
	overlay unbroken and first={
		...
		at ([yshift=-0.55ex]frame.north west) {\hfill#1};
           ...
           (frame.south west) rectangle ([xshift=-1.8in]frame.north east);
        \end{tcbclipinterior},
	},
   overlay middle={
           \begin{tcbclipinterior}\fill[color4,opacity=0.25]
...
{%
    \IfValueT{#1}{%
        \href{https://www.facebook.com/#1}{%
            \makebox[0.4cm][c]{\githubsymbol} \ttfamily github}\par%
            }%
}%
...
{%
    \IfValueT{#1}{%
        \href{https://www.facebook.com/#1}{%
            \makebox[0.4cm][c]{\twittersymbol} \ttfamily Twitter} \par%
            }%
}%
...
{%
    \IfValueT{#1}{%
        \href{https://www.facebook.com/#1}{%
            \makebox[0.4cm][c]{\linkedinsymbol} \ttfamily LinkedIn} \par%
            }%
}%
...
{%
    \IfValueT{#1}{%
        \href{https://www.facebook.com/#1}{%
            \hspace*{-0.55ex}\makebox[0.4cm][l]{\homepagesymbol} \ttfamily \hspace{0.55ex}Home page}
             \par%
            }%
}%
...
\patchcmd{\@maketitle}
    ...
    {\begin{minipage}[t]{\textwidth}%
       ...
       \hfill
       \begin{minipage}[t]{0.33\textwidth}
         \facebookdetail[srinivas.upadhya]
	     \twitterdetail[srinivas.upadhya]
         \linkedindetail[srinivas.upadhya]
         \githubdetail[srinivas.upadhya]
         \homepagedetail[srinivas.upadhya]
       \end{minipage}%
       \hfill
       \begin{minipage}[t]{0.33\textwidth}
          \begin{tabular}[t]{@{}r!{:}l@{}}
            \color{black!65!white}\Large\fixedphonesymbol   & Land line \\
            \color{black!65!white}\Large\mobilephonesymbol  & Mobile phone \\
            \color{black!65!white}\small\faxphonesymbol     & Fax phone \\
            \color{black!65!white}\emailsymbol              & e-mail
          \end{tabular}
       \end{minipage}
	\end{minipage}}
\makeatother
